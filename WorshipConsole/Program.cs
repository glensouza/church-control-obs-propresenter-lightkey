...
await using (AsyncServiceScope scope = app.Services.CreateAsyncScope())
{
    ...
    if (!await db.Cameras.AnyAsync())
    {
        ...
        db.Cameras.AddRange(
            new CameraInfo { Name = "Camera 1 (Left)", IpAddress = "10.0.10.101", ViscaPort = 5678, UniFiPortNumber = 1, PanSpeed = 10, TiltSpeed = 10, ZoomSpeed = 4, NumberOfPresets = 9 }, 
            new CameraInfo { Name = "Camera 2 (Center)", IpAddress = "10.0.10.102", ViscaPort = 5678, UniFiPortNumber = 2, PanSpeed = 8, TiltSpeed = 8, ZoomSpeed = 3, NumberOfPresets = 9 }, 
            new CameraInfo { Name = "Camera 3 (Right)", IpAddress = "10.0.10.103", ViscaPort = 5678, UniFiPortNumber = 3, PanSpeed = 10, TiltSpeed = 10, ZoomSpeed = 4, NumberOfPresets = 9 }, 
            new CameraInfo { Name = "Camera 4 (Stage)", IpAddress = "10.0.10.104", ViscaPort = 5678, UniFiPortNumber = 4, PanSpeed = 10, TiltSpeed = 10, ZoomSpeed = 4, NumberOfPresets = 9 }
        );
